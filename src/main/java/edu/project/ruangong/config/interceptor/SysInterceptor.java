//package edu.project.ruangong.config.interceptor;
...
//import edu.project.ruangong.config.configentity.R;
//import edu.project.ruangong.utils.JwtUtils;
...
//        	  logger.info("fail");
//        	  print(response, R.error(SystemConstant.JWT_ERRCODE_NULL,"not exist"));
//              return false;
//            }else{
...
//                    	logger.info("no pass");
//                    	print(response,R.error(checkResult.getErrCode(),"no pass"));
//                    	break;
//                     // 签名过期，返回过期提示码
//                    case SystemConstant.JWT_ERRCODE_EXPIRE:
//                    	logger.info("expire");
//                    	print(response,R.error(checkResult.getErrCode(),"expire"));
//                    	break;
//                    default:
//                        break;
//                    }
